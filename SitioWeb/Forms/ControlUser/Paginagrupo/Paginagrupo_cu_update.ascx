<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Paginagrupo_CU_Update.ascx.cs" Inherits="SitioWeb.Forms.ControlUser.Paginagrupo.Paginagrupo_CU_Update" %>

<script type="text/javascript">

    function CargarModalUpdatePaginagrupo(uid) {
        var control = document.getElementById('txt_buscarUpdateUIDPaginagrupo');
        control.value = uid;
        var btnBuscarUpdateRegistro = document.getElementById('btnUpdatePaginagrupoMostrarModal');
        __doPostBack(btnBuscarUpdateRegistro.name, '');
    }
</script>
<div style="display: none;">
    <asp:TextBox ID="txt_buscarUpdateUIDPaginagrupo" runat="server" ClientIDMode="Static"></asp:TextBox>
    <asp:Button ID="btnUpdatePaginagrupoMostrarModal" runat="server" Text="MostrarModal" ClientIDMode="Static"
        OnClick="btnUpdatePaginagrupoMostrarModal_Click" />
</div>
<!-- Modal update-->
<div class="modal fade" id="Update-modal-default">
   ...
   <asp:Label ID="lbl_uidpaginagrupo_update" AssociatedControlID="txt_uidpaginagrupo_update" runat="server" Text="uidpaginagrupo <b style='color:red;'> *</b>"></asp:Label>
			  <asp:TextBox  Enabled="true"  ID = "txt_uidpaginagrupo_update" runat = "server" CssClass="form-control"  MaxLength="36"   Width="100 %"></asp:TextBox> 
</div>
			  <div class="col-xs-3 ">  
