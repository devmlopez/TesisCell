<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Paginagrupo_CU_Insert.ascx.cs" Inherits="SitioWeb.Forms.ControlUser.Paginagrupo.Paginagrupo_CU_Insert" %>
<%@ Register Src="~/Forms/ControlUser/MsgControl.ascx" TagPrefix="uc1" TagName="MsgControl" %>
   ...
   <asp:Label ID="lbl_uidpaginagrupo_insert" AssociatedControlID="txt_uidpaginagrupo_insert" runat="server" Text="uidpaginagrupo <b style='color:red;'> *</b>"></asp:Label>
			  <asp:TextBox  Enabled="true"  ID = "txt_uidpaginagrupo_insert" runat = "server" CssClass="form-control"  MaxLength="36"   Width="100 %"></asp:TextBox> 
</div>
			  <div class="col-xs-3 ">  
