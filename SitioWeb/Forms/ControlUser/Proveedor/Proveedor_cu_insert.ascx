<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Proveedor_CU_Insert.ascx.cs" Inherits="SitioWeb.Forms.ControlUser.Proveedor.Proveedor_CU_Insert" %>
<%@ Register Src="~/Forms/ControlUser/MsgControl.ascx" TagPrefix="uc1" TagName="MsgControl" %>
   ...
   <asp:Label ID="lbl_uidproveedor_insert" AssociatedControlID="txt_uidproveedor_insert" runat="server" Text="UIDPROVEEDOR <b style='color:red;'> *</b>"></asp:Label>
			  <asp:TextBox  Enabled="true"  ID = "txt_uidproveedor_insert" runat = "server" CssClass="form-control"  MaxLength="36"   Width="100 %"></asp:TextBox> 
</div>
			  <div class="col-xs-3 oculto">
   <asp:Label ID="lbl_id_proveedor_insert" AssociatedControlID="txt_id_proveedor_insert" runat="server" Text="Cod. Proveedor <b style='color:red;'> *</b>"></asp:Label>
			  <asp:TextBox  Enabled="true"  ID = "txt_id_proveedor_insert" runat = "server" CssClass="form-control" TextMode="Number" step="1"  min="0" max="9999999999"   Width="100 %"></asp:TextBox> 
</div>
			  <div class="col-xs-3 ">  
 <asp:Label ID="lbl_uidtipopersona_insert" AssociatedControlID="cb_uidtipopersona_insert" runat="server" Text="Tipo de Persona <b style='color:red;'> *</b>"></asp:Label>
			  ...
			  <div class="col-xs-3 ">
   <asp:Label ID="lbl_identificacion_insert" AssociatedControlID="txt_identificacion_insert" runat="server" Text="Identificacion <b style='color:red;'> *</b>"></asp:Label>
 ...
 <asp:Label ID="lbl_uidtipoidentificacion_insert" AssociatedControlID="cb_uidtipoidentificacion_insert" runat="server" Text="Tipo Identificación <b style='color:red;'> *</b>"></asp:Label>
			  ...
			  <div class="col-xs-3 ">
   <asp:Label ID="lbl_razonsocial_insert" AssociatedControlID="txt_razonsocial_insert" runat="server" Text="Razón Social <b style='color:red;'> *</b>"></asp:Label>
   ...
   <asp:Label ID="lbl_nombre_insert" AssociatedControlID="txt_nombre_insert" runat="server" Text="Nombre <b style='color:red;'> *</b>"></asp:Label>
			  ...
			  <div class="col-xs-3 ">
   <asp:Label ID="lbl_contacto_insert" AssociatedControlID="txt_contacto_insert" runat="server" Text="Conacto"></asp:Label>
   ...
   <asp:Label ID="lbl_observaciones_insert" AssociatedControlID="txt_observaciones_insert" runat="server" Text="Observaciones"></asp:Label>
			  ...
			  <div class="col-xs-3 ">
   <asp:Label ID="lbl_pagina_web_insert" AssociatedControlID="txt_pagina_web_insert" runat="server" Text="Pag. Web <b style='color:red;'> *</b>"></asp:Label>
			  <asp:TextBox  Enabled="true"  ID = "txt_pagina_web_insert" runat = "server" CssClass="form-control"  MaxLength="1000"   Width="100 %"></asp:TextBox> 
</div>
