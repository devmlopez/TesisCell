...
{
    public partial class Menu_CU_Detalle : System.Web.UI.UserControl
    {
        ...
        {
            string resultado = "";
            var objeto = new SitioWeb.Controlador.ClassMenu();
            var retSelect = SitioWeb.Controlador.SqlMenu.SelectDataTable(ClasesUtiles.SessionClass.GetLoginUser(Page).classLoginUser.uidsuario, objeto, out resultado);
