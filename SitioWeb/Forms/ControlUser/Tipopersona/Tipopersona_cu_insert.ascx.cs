...
{
    public partial class Tipopersona_CU_Insert : System.Web.UI.UserControl
    {
		 ...
		 private void LimpiarControlesNuevo()
        {
			...
			txt_uidtipopersona_insert.Text = Guid.NewGuid().ToString();
			txt_tipopersona_insert.Text = "";
        ...
        private void GuardarNuevo()
        {
		  ...
		  private SitioWeb.Controlador.ClassTipopersona GetClass_Control_New()
        {
            var c=new SitioWeb.Controlador.ClassTipopersona();

			
				 c.uidtipopersona =ClasesUtiles.Util.ConvertStringToStringNull(txt_uidtipopersona_insert.Text);
				 c.tipopersona =ClasesUtiles.Util.ConvertStringToStringNull(txt_tipopersona_insert.Text);
            return c;
        }
