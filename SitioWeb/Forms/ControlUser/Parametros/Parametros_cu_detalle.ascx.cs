...
{
    public partial class Parametros_CU_Detalle : System.Web.UI.UserControl
    {
        ...
        {
            string resultado = "";
            var objeto = new SitioWeb.Controlador.ClassParametros();
            var retSelect = SitioWeb.Controlador.SqlParametros.Select(ClasesUtiles.SessionClass.GetLoginUser(Page).classLoginUser.uidsuario, objeto, out resultado);
