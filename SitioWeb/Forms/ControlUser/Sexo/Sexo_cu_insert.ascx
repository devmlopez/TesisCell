<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Sexo_CU_Insert.ascx.cs" Inherits="SitioWeb.Forms.ControlUser.Sexo.Sexo_CU_Insert" %>
<%@ Register Src="~/Forms/ControlUser/MsgControl.ascx" TagPrefix="uc1" TagName="MsgControl" %>
   ...
   <asp:Label ID="lbl_uidsexo_insert" AssociatedControlID="txt_uidsexo_insert" runat="server" Text="uidsexo <b style='color:red;'> *</b>"></asp:Label>
			  <asp:TextBox  Enabled="true"  ID = "txt_uidsexo_insert" runat = "server" CssClass="form-control"  MaxLength="36"   Width="100 %"></asp:TextBox> 
</div>
			  <div class="col-xs-3 ">
   <asp:Label ID="lbl_sexo_insert" AssociatedControlID="txt_sexo_insert" runat="server" Text="Sexo <b style='color:red;'> *</b>"></asp:Label>
			  <asp:TextBox  Enabled="true"  ID = "txt_sexo_insert" runat = "server" CssClass="form-control"  MaxLength="20"   Width="100 %"></asp:TextBox> 
</div>
