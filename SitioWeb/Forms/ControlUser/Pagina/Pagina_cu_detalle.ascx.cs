...
{
    public partial class Pagina_CU_Detalle : System.Web.UI.UserControl
    {
        ...
        {
            string resultado = "";
            var objeto = new SitioWeb.Controlador.ClassPagina();
            var retSelect = SitioWeb.Controlador.SqlPagina.Select(ClasesUtiles.SessionClass.GetLoginUser(Page).classLoginUser.uidsuario, objeto, out resultado);
