...
{
    public partial class Tipoidentificacion_CU_Insert : System.Web.UI.UserControl
    {
		 ...
		 private void LimpiarControlesNuevo()
        {
			...
			txt_uidtipoidentificacion_insert.Text = Guid.NewGuid().ToString();
			txt_tipoidentificacion_insert.Text = "";
        ...
        private void GuardarNuevo()
        {
            ...
            if (Controlador.SqlTipoidentificacion.ValidarCamposNulos(objeto).Count() == 0)
            {
                SitioWeb.Controlador.SqlTipoidentificacion.InsertInto(ClasesUtiles.SessionClass.GetLoginUser(Page).classLoginUser.uidsuario, objeto, out resultado);
            }
            else
            {
		  ...
		  private SitioWeb.Controlador.ClassTipoidentificacion GetClass_Control_New()
        {
            var c=new SitioWeb.Controlador.ClassTipoidentificacion();

			
				 c.uidtipoidentificacion =ClasesUtiles.Util.ConvertStringToStringNull(txt_uidtipoidentificacion_insert.Text);
				 c.tipoidentificacion =ClasesUtiles.Util.ConvertStringToStringNull(txt_tipoidentificacion_insert.Text);
            return c;
        }
