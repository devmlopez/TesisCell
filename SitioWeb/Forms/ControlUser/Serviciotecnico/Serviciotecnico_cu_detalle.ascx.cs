...
{
    public partial class Serviciotecnico_CU_Detalle : System.Web.UI.UserControl
    {
        ...
        {
            string resultado = "";
            var objeto = new SitioWeb.Controlador.ClassServiciotecnico();
            var retSelect = SitioWeb.Controlador.SqlServiciotecnico.SelectDataTable(ClasesUtiles.SessionClass.GetLoginUser(Page).classLoginUser.uidsuario, objeto, out resultado);
