...
{
    public partial class Proceso_CU_Detalle : System.Web.UI.UserControl
    {
        ...
        {
            string resultado = "";
            var objeto = new SitioWeb.Controlador.ClassProceso();
          
            var retSelect = SitioWeb.Controlador.SqlProceso.SelectDataTable(ClasesUtiles.SessionClass.GetLoginUser(Page).classLoginUser.uidsuario, objeto, out resultado);
