...
<%@ Page Title="" Language="C#" EnableEventValidation="false" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Media.aspx.cs" Inherits="SitioWeb.Forms.Media" %>
...
<%@ Register Src="~/Forms/ControlUser/Media/Media_CU_Update.ascx" TagPrefix="uc1" TagName="Media_CU_Update" %>
        ...
        <div class="col-xs-12">
            ...
            <div class="box">
                ...
                <div class="box-body">
                    ...
                    <uc1:Media_CU_Update runat="server" id="Media_CU_Update" />
                    <uc1:Media_CU_Delete runat="server" id="Media_CU_Delete" />


                    <!-- TABLA CONTENDO -->
					 <div style="margin-bottom:5px;"></div>
                    <uc1:Media_CU_Detalle runat="server" id="Media_CU_Detalle" />
                    <!-- TABLA CONTENDO FIN -->
                    <uc1:Media_CU_Select EsModal="True" runat="server" id="Media_CU_Select" />
                </div>
                <!-- /.box-body -->
            </div>
            <!-- /.box -->
